...
public class QueryMarkPriceKline extends BaseTest {
    String request = UsdtPerpetual.QUERY_MARK_PRICE_KLINE;

    @DataProvider(name="testQueryMarkPriceKline")
    public Object[][] getData() throws IOException {
        //read data from excel
        String path = System.getProperty("user.dir") + "/src/test/java/resources/usdtperpetual/testQueryMarkPriceKline.xlsx";
    ...
    @Test(dataProvider = "testQueryMarkPriceKline")
    public void QueryMarkPriceKline(String symbol, String interval, String limit){
        ExtentTest extentTest = extentReports.createTest("QueryMarkPriceKline","to verify GetTheLastFundingRate response");
