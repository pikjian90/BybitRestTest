...
public class PublicTradingRecords extends BaseTest {
    String request = UsdtPerpetual.PUBLIC_TRADE_RECORDS;

    @DataProvider(name="testPublicTradingRecords")
    public Object[][] getData() throws IOException {
        //read data from excel
        String path = System.getProperty("user.dir") + "/src/test/java/resources/usdtperpetual/testPublicTradingRecords.xlsx";
