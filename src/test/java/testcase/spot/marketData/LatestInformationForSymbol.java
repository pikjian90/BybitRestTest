...
public class LatestInformationForSymbol extends BaseTest {
    String request = Spot.LATEST_INFORMATION_FOR_SYMBOL;

    @DataProvider(name="testLatestInformationForSymbol")
    public Object[][] getData() throws IOException {
        //read data from excel
        String path = System.getProperty("user.dir") + "/src/test/java/resources/spot/testLatestInformationForSymbol.xlsx";
