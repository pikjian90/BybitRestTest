...
public class LastTradedPrice extends BaseTest {
    String request = Spot.LATEST_TRADED_PRICE;

    @DataProvider(name="testLastTradedPrice")
    public Object[][] getData() throws IOException {
        //read data from excel
        String path = System.getProperty("user.dir") + "/src/test/java/resources/spot/testLastTradedPrice.xlsx";
    ...
    @Test(dataProvider = "testLastTradedPrice")
    ...
    @Test(dataProvider = "testLastTradedPrice")
    public void testLastTradedPrice(String symbol){
        ExtentTest extentTest = extentReports.createTest("testLastTradedPrice","to verify LastTradedPrice response");
