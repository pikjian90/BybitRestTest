...
public class QueryIndexPriceKline extends BaseTest {
    String request = InversePerpetualRequest.QUERY_INDEX_PRICE_KLINE;

    @DataProvider(name="testQueryIndexPriceKline")
    public Object[][] getData() throws IOException {
        //read data from excel
        String path = System.getProperty("user.dir") + "/src/test/java/resources/inverseperpetual/testQueryIndexPriceKline.xlsx";
