...
public class QuerySymbol extends BaseTest {
    String request = InversePerpetualRequest.QUERY_SYMBOL;
    ...
    public void testQuerySymbol(String symbol, String baseCurrency, String quoteCurrency){
        ...
        try {
            ...
            softAssert.assertEquals(hm.get("alias"),symbol,"alias in Response is not same as expected");
            softAssert.assertEquals(hm.get("status"),"Trading","status in Response is not same as expected");
            softAssert.assertEquals(hm.get("base_currency"),baseCurrency,"name in Response is not same as expected");
            softAssert.assertEquals(hm.get("quote_currency"),quoteCurrency,"name in Response is not same as expected");
