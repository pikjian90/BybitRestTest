...
public class OrderBook extends BaseTest {
    String request = InversePerpetualRequest.ORDER_BOOK;

    @DataProvider(name="testOrderBook")
    public Object[][] getData() throws IOException {
        //read data from excel
        String path = System.getProperty("user.dir") + "/src/test/java/resources/inverseperpetual/testOrderBook.xlsx";
    ...
    @Test(dataProvider = "testOrderBook")
    public void testOrderBook(String symbol){
        ExtentTest extentTest = extentReports.createTest("testOrderBook","to verify OrderBook response");
