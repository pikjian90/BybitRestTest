...
public class QueryMarkPriceKline extends BaseTest {
    String request = InversePerpetualRequest.QUERY_MARK_PRICE_KLINE;

    @DataProvider(name="testQueryMarkPriceKline")
    public Object[][] getData() throws IOException {
        //read data from excel
        String path = System.getProperty("user.dir") + "/src/test/java/resources/inverseperpetual/testQueryMarkPriceKline.xlsx";
    ...
    @Test(dataProvider = "testQueryMarkPriceKline")
    ...
    @Test(dataProvider = "testQueryMarkPriceKline")
    public void testQueryMarkPriceKline(String symbol, String interval, String limit){
        ExtentTest extentTest = extentReports.createTest("testQueryMarkPriceKline","to verify testQueryMarkPriceKline response");
